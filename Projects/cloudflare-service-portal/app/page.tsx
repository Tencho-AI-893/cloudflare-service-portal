...
type Slide = {
  ...
  title: string;
  description: string;
  color: string; // Tailwindのbg-xxx-100形式
};
...
export default function PresentationSlide() {
  ...
  return (
    <section className="relative py-16 px-4 bg-gradient-to-br from-yellow-100 via-pink-100 to-purple-100 min-h-[70vh] flex flex-col justify-center items-center select-none">
      ...
      <div className="relative w-full max-w-lg mx-auto">
        ...
        >
          <div className="text-7xl mb-6 drop-shadow-lg animate-bounce-in">
            {slide.emoji}
          </div>
